...
p1 <- df %>%
    ...
    labs(title = "Asset Items in the Absa Ltd Balance Sheet")
...
p1 <- df %>%
    ...
    labs(title = "Liabilities in the Top 6 Banks' Balance Sheet",
         subtitle = "Aggregated for all banks")
...
p1 <- df %>%
    ...
    labs(title = "Assets & Equity in the Top Six Banks' Balance Sheet",
         )

p1
```

Next, all these variables are plotted as their differenced values.
...
p1 <- df %>%
    ...
    labs(
        title = 
             "Change in Assets & Equity for the Top Six Banks' Balance Sheet")
